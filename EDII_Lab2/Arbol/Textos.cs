...
namespace EDII_Lab2.Arbol
{
    public class Textos<TKey, T> where TKey : IComparable<TKey> where T : IComparable<T>//PODES MODIFICAR LO ESCRITO ENTRE COMILLAS, QUE ES LO QUE SE ESCRIBE EN EL ARCHIVO
    {
